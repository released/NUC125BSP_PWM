...
#line 10 "..\\..\\..\\..\\Library\\StdDriver\\src\\i2c.c"
...
void I2C_Close(I2C_T *i2c)
{
    ...
    {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 |= (0x1ul << (8));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 &= ~(0x1ul << (8));
    }
    else if ((uint32_t)i2c == (((uint32_t)0x40100000) + 0x20000))
    {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 |= (0x1ul << (9));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 &= ~(0x1ul << (9));
    }
...
uint32_t I2C_GetIntFlag(I2C_T *i2c)
{
    return ((i2c->CTL & (0x1ul << (3))) == (0x1ul << (3)) ? 1 : 0);
}
...
uint8_t I2C_WriteByte(I2C_T *i2c, uint8_t u8SlaveAddr, const uint8_t u8Data)
{
    ...
    ((i2c)->CTL = ((i2c)->CTL | (0x1ul << (3))) | (0x1ul << (5)));

    while (u8Xfering && (u8Err == 0))
    {
        while(!((i2c)->CTL & (0x1ul << (3))));

        switch (((i2c)->STATUS))
        {
            case 0x08:
                ((i2c)->DAT = ((u8SlaveAddr << 1 | 0x00)));     
                u8Ctrl = 0x08UL;                            
                break;
...
uint8_t I2C_WriteByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, const uint8_t u8Data)
{
    ...
    while (u8Xfering && (u8Err == 0))
    {
        ...
        switch (((i2c)->STATUS))
        {
            ...
            case 0x18:                                                       
                ((i2c)->DAT = ((uint8_t)((u16DataAddr & 0xFF00) >> 8)));     
                break;
            ...
            case 0x28:
                if (u8Addr)
                {
                    ((i2c)->DAT = ((uint8_t)(u16DataAddr & 0xFF)));        
                    u8Addr = 0;
                }
...
uint32_t I2C_ReadMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t *pu8rData, uint32_t u32rLen)
{
    ...
    while (u8Xfering && (u8Err == 0))
    {
        ...
        switch (((i2c)->STATUS))
        {
            ...
            case 0x50:
                pu8rData[u32rxLen++] = (unsigned char) ((i2c)->DAT);     
...
uint32_t I2C_ReadMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t *pu8rData, uint32_t u32rLen)
{
    ...
    while (u8Xfering && (u8Err == 0))
    {
        ...
        switch (((i2c)->STATUS))
        {
            ...
            case 0x50:
                pu8rData[u32rxLen++] = (uint8_t) ((i2c)->DAT);    
