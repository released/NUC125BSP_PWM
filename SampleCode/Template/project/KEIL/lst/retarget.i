...
#line 365 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"


 
#line 452 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
...
#line 568 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
...
void SendChar(int ch)
{
#line 604 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    SendChar_ToUART(ch);
...
char GetChar(void)
{
#line 644 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"

    while (1)
    {
        if ((((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
...
int kbhit(void)
{
    return !((((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FIFOSTS & (0x1ul << (14))) == 0U);
}
...
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FIFOSTS & (0x1ul << (28))) != 0U);
}
...
#line 769 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
