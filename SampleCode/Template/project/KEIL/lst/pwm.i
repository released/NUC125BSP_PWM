...
#line 10 "..\\..\\..\\..\\Library\\StdDriver\\src\\pwm.c"
...
uint32_t PWM_ConfigCaptureChannel(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    if (pwm == ((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))
        u32Src = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x1ul << (30));
    else
        u32Src = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x1ul << (31));
    ...
    (*(volatile uint32_t *) (&((pwm)->CLKPSC0_1) + ((u32ChannelNum) >> 1)) = (--u16Prescale));

    
    (pwm)->CTL1 = ((pwm)->CTL1 & ~((0x3ul << (0)) << ((u32ChannelNum >> 1) << 2))) | (1UL << ((u32ChannelNum >> 1) << 2));

    ((pwm)->PERIOD[(((u32ChannelNum) >> 1) << 1)] = (u16CNR));
...
uint32_t PWM_ConfigOutputChannel(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    if (u32DutyCycle)
    {
        if (u32DutyCycle >= 100)
            ...
            ((pwm)->CMPDAT[(u32ChannelNum)] = (u32DutyCycle * (u16CNR + 1) / 100));

        (pwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2));
        (pwm)->WGCTL0 |= ((1UL) << (u32ChannelNum * 2 + (16)));
        (pwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2));
        (pwm)->WGCTL1 |= ((2UL) << (u32ChannelNum * 2 + (16)));
    }
    else
    {
        ((pwm)->CMPDAT[(u32ChannelNum)] = (0));
        (pwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2));
        (pwm)->WGCTL0 |= ((1UL) << (u32ChannelNum * 2 + (0)));
        (pwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2));
        (pwm)->WGCTL1 |= ((2UL) << (u32ChannelNum * 2 + (16)));
    }
...
void PWM_EnableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if (u32ChannelNum < 4)
    {
        (pwm)->ADCTS0 &= ~(((0xful << (0))) << (u32ChannelNum * 8));
        (pwm)->ADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum * 8));
    }
    else
    {
        (pwm)->ADCTS1 &= ~(((0xful << (0))) << ((u32ChannelNum - 4) * 8));
        (pwm)->ADCTS1 |= (((0x1ul << (7)) | u32Condition) << ((u32ChannelNum - 4) * 8));
    }
}
...
void PWM_DisableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum)
{
    if (u32ChannelNum < 4)
    {
        (pwm)->ADCTS0 &= ~((0x1ul << (7)) << (u32ChannelNum * 8));
    }
    else
    {
        (pwm)->ADCTS1 &= ~((0x1ul << (7)) << ((u32ChannelNum - 4) * 8));
    }
}
...
uint32_t PWM_GetADCTriggerFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->STATUS & ((0x1ul << (16)) << u32ChannelNum)) ? 1 : 0);
}
...
void PWM_EnableFaultBrake(PWM_T *pwm, uint32_t u32ChannelMask, uint32_t u32LevelMask, uint32_t u32BrakeSource)
{
    ...
    for (i = 0; i < (6); i ++)
    {
        if (u32ChannelMask & (1 << i))
        {
            ...
            {
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= (u32BrakeSource & ((0x1ul << (7)) | (0x1ul << (15))));
                (pwm)->FAILBRK |= (u32BrakeSource & 0xB);
            }
            else
            {
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= u32BrakeSource;
            }
        }
        ...
        if (u32LevelMask & (1 << i))
        {
            if (i % 2 == 0)
            {
                ...
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) &= ~(0x3ul << (16));
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= ((3UL) << (16));
            }
            else
            {
                
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) &= ~(0x3ul << (18));
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= ((3UL) << (18));
            }
        }
        else
        {
            if (i % 2 == 0)
            {
                ...
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) &= ~(0x3ul << (16));
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= ((2UL) << (16));
            }
            else
            {
                
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) &= ~(0x3ul << (18));
                *(volatile uint32_t *)(&((pwm)->BRKCTL0_1) + (i >> 1)) |= ((2UL) << (18));
            }
        }
    }
...
void PWM_EnableDeadZone(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    *(volatile uint32_t *)(&((pwm)->DTCTL0_1) + (u32ChannelNum >> 1)) &= ~(0xffful << (0));
    *(volatile uint32_t *)(&((pwm)->DTCTL0_1) + (u32ChannelNum >> 1)) |= (0x1ul << (16)) | u32Duration;
}
...
void PWM_DisableDeadZone(PWM_T *pwm, uint32_t u32ChannelNum)
{
    ...
    *(volatile uint32_t *)(&((pwm)->DTCTL0_1) + (u32ChannelNum >> 1)) &= ~(0x1ul << (16));
}
...
uint32_t PWM_GetCaptureIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((((pwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1 : 0) << 1) |             (((pwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1 : 0));
...
void PWM_EnablePeriodInt(PWM_T *pwm, uint32_t u32ChannelNum,  uint32_t u32IntPeriodType)
{
    ...
    (pwm)->INTEN0 |= ((0x1ul << (8)) << ((u32ChannelNum >> 1) << 1));
}
...
void PWM_ClearPeriodIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTSTS0 = ((0x1ul << (8)) << ((u32ChannelNum >> 1) << 1));
}
...
uint32_t PWM_GetPeriodIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->INTSTS0 & ((0x1ul << (8)) << ((u32ChannelNum >> 1) << 1))) ? 1 : 0);
}
...
void PWM_EnableZeroInt(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTEN0 |= ((0x1ul << (0)) << ((u32ChannelNum >> 1) << 1));
}
...
void PWM_ClearZeroIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTSTS0 = ((0x1ul << (0)) << ((u32ChannelNum >> 1) << 1));
}
...
uint32_t PWM_GetZeroIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->INTSTS0 & ((0x1ul << (0)) << ((u32ChannelNum >> 1) << 1))) ? 1 : 0);
}
...
void PWM_SetClockSource(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32ClkSrcSel)
{
    (pwm)->CLKSRC = ((pwm)->CLKSRC & ~((0x7ul << (0)) << ((u32ChannelNum >> 1) * (8)))) |                     (u32ClkSrcSel << ((u32ChannelNum >> 1) * (8)));
...
void PWM_SetBrakePinSource(PWM_T *pwm, uint32_t u32BrakePinNum, uint32_t u32SelAnotherModule)
{
    (pwm)->BNF = ((pwm)->BNF & ~((0x1ul << (16)) << (u32BrakePinNum * 8))) | (u32SelAnotherModule << ((16) + u32BrakePinNum * 8));
}
...
uint32_t PWM_GetWrapAroundFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->STATUS & ((0x1ul << (0)) << ((u32ChannelNum >> 1) << 1))) ? 1 : 0);
}
...
void PWM_ClearWrapAroundFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->STATUS = ((0x1ul << (0)) << ((u32ChannelNum >> 1) << 1));
}
...
void PWM_EnablePDMA(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32RisingFirst, uint32_t u32Mode)
{
    ...
    (pwm)->PDMACTL = ((pwm)->PDMACTL & ~(((0x1ul << (4)) | (0x1ul << (3)) | (0x3ul << (1))) << ((u32ChannelNum >> 1) * 8))) |                      (((u32IsOddCh << (4)) | (u32RisingFirst << (3)) |                        u32Mode | (0x1ul << (0))) << ((u32ChannelNum >> 1) * 8));
...
void PWM_DisablePDMA(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->PDMACTL &= ~((0x1ul << (0)) << ((u32ChannelNum >> 1) * 8));
}
