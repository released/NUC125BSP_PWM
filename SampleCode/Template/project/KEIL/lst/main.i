...
void PWM_Set_Duty(uint8_t channel , uint8_t DutyCycle)
{
    ...
    u32NewCMR = ((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->PERIOD[(((channel) >> 1) << 1)]);
	
    u32NewCMR = u32NewCMR * (100-DutyCycle)/100;	

    
	((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->CMPDAT[(channel)] = (u32NewCMR));
...
void PWM_Init(void)
{
    PWM_ConfigOutputChannel(((PWM_T *) (((uint32_t)0x40000000) + 0x44000)), (0), 10000, 50);
    PWM_ConfigOutputChannel(((PWM_T *) (((uint32_t)0x40000000) + 0x44000)), (4), 10000, 50);
    PWM_ConfigOutputChannel(((PWM_T *) (((uint32_t)0x40000000) + 0x44000)), (5), 10000, 50);
	
    PWM_EnableOutput(((PWM_T *) (((uint32_t)0x40000000) + 0x44000)), (0x1UL)|(0x10UL)|(0x20UL));
	
  	do{ int i; for(i = 0; i < 6; i++) { if((((0x1UL)|(0x10UL)|(0x20UL))) & (1 << i)) { (((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL0 = (((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL0 & ~(3UL << (2 * i))) | (((0UL)) << (2 * i))); (((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL0 = (((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL0 & ~(3UL << ((16) + (2 * i)))) | (((2UL)) << ((16) + (2 * i)))); (((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL1 = (((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL1 & ~(3UL << (2 * i))) | (((0UL)) << (2 * i))); (((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL1 = (((((PWM_T *) (((uint32_t)0x40000000) + 0x44000)))->WGCTL1 & ~(3UL << ((16) + (2 * i)))) | (((1UL)) << ((16) + (2 * i)))); } } }while(0);

     
    PWM_Start(((PWM_T *) (((uint32_t)0x40000000) + 0x44000)), ((0x1UL)|(0x10UL)|(0x20UL)));
}


void GPIO_Init(void)
{
    GPIO_SetMode(((GPIO_T *) ((((uint32_t)0x50000000) + 0x04000) + 0x00040)), 0x00000010, 0x1UL);
}
...
void TMR3_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) (((uint32_t)0x40100000) + 0x10020))) == 1)
    {
        TIMER_ClearIntFlag(((TIMER_T *) (((uint32_t)0x40100000) + 0x10020)));
	
		if (CNT++ >= 1000)
		{		
			CNT = 0;
			(*((volatile uint32_t *)((((((uint32_t)0x50000000) + 0x04000) + 0x00200)+(0x40*(1))) + ((4)<<2)))) ^= 1;
...
{
    TIMER_Open(((TIMER_T *) (((uint32_t)0x40100000) + 0x10020)), (1UL << (27)), 1000);
    TIMER_EnableInt(((TIMER_T *) (((uint32_t)0x40100000) + 0x10020)));
    __NVIC_EnableIRQ(TMR3_IRQn);	
    TIMER_Start(((TIMER_T *) (((uint32_t)0x40100000) + 0x10020)));
}
...
{
	uint8_t res = 0;
	res = ((((UART_T *) (((uint32_t)0x40000000) + 0x50000)))->DAT);
...
void UART0_IRQHandler(void)
{
    ...
    if((((((UART_T *) (((uint32_t)0x40000000) + 0x50000)))->INTSTS & ((0x1ul << (8)) | (0x1ul << (12))))?1:0))      
    {
        while(((((UART_T *) (((uint32_t)0x40000000) + 0x50000)))->FIFOSTS & (0x1ul << (14))) == 0)
        {
            UARTx_Process();
        }
    }
...
void UART0_Init(void)
{
	...
	UART_SetTimeoutCnt(((UART_T *) (((uint32_t)0x40000000) + 0x50000)), 20);

    UART_EnableInt(((UART_T *) (((uint32_t)0x40000000) + 0x50000)), (0x1ul << (0)) | (0x1ul << (4)));
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((5)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((20) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((5)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((20) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x2UL<<(20)), 0);

    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((22)) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((1) & 0x07) << 25)|(((30) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((22)) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((1) & 0x07) << 25)|(((30) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x1UL<<(30)), 0);
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPB_MFPL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPB_MFPL & (~(0xful << (0)))) | (0x1UL<<(0));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPB_MFPL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPB_MFPL & (~(0xful << (4)))) | (0x1UL<<(4));

    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH & (~(0xful << (0)))) | (0x4UL<<(0));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH & (~(0xful << (4)))) | (0x4UL<<(4));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPC_MFPH & (~(0xful << (8)))) | (0x4UL<<(8));
