...
#line 10 "..\\..\\..\\..\\Library\\StdDriver\\src\\timer.c"
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    const uint32_t au32Clk[] = {(12000000UL), (32768UL), 0, 0, 0, (10000UL), 0, ((48000000UL)/2)};
    ...
    else if (timer == ((TIMER_T *) (((uint32_t)0x40100000) + 0x10020)))
    ...
    if (u32Src == 2)
    {
        if ((timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10000))) || (timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10020))))
        {
