...
void CLK_DisableCKO(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK0 &= (~(0x1ul << (6)));
}
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (~(0x7ul << (2)))) | (u32ClkSrc);
...
void CLK_PowerDown(void)
{
    ...
    u32HIRCTRIMCTL = ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL;

     
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL &= (~(0x3ul << (0)));

     
    __wfi();

     
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL = u32HIRCTRIMCTL;
}
...
uint32_t CLK_GetHXTFreq(void)
{
    if (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x01UL<<(0)))
        return (12000000UL);
    else
        return 0;
}
...
uint32_t CLK_GetLXTFreq(void)
{
    if (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x02UL<<(0)))
        return (32768UL);
    else
        return 0;
}
...
uint32_t CLK_GetPCLK0Freq(void)
{
    ...
    if (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (6)))
...
uint32_t CLK_GetPCLK1Freq(void)
{
    ...
    if (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (7)))
        return SystemCoreClock >> 1;
    else
        return SystemCoreClock;
}
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 &= (~(0xful << (0)));

     
    if (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->STATUS & (0x1ul << (0)))
        u32Hclk = CLK_EnablePLL(0x00000000UL, (u32Hclk << 1));

     
    else
    {
        u32Hclk = CLK_EnablePLL(0x00880000UL, (u32Hclk << 1));
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | (0x04UL<<(0));
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if ((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32div = (uint32_t)&((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 + (u32DivTbl[(((u32ModuleIdx) >>18) & 0x3)]);
...
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    if (((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL | u32ClkMask) & (0x3ul << (0))) == (0x3ul << (0)))
        return;
...
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    ...
    *(volatile uint32_t *)((uint32_t)&((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->AHBCLK + (u32ClkTbl[(((u32ModuleIdx) >>30) & 0x3)]))  |= 1 << (((u32ModuleIdx) >>0 ) & 0x1f);
}
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if (u32PllClkSrc == 0x00000000UL)
    {
        ...
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & ~(0x3ul << (0))) | (0x01UL<<(0));
    ...
    if ((u32PllFreq <= 500000000) && (u32PllFreq > 250000000))
    {
        u32NO = 0;
    }
    else if ((u32PllFreq <= 250000000) && (u32PllFreq > 125000000))
    {
        u32NO = 1;
        u32PllFreq = u32PllFreq << 1;
    }
    else if ((u32PllFreq <= 125000000) && (u32PllFreq >= 50000000))
    {
        u32NO = 3;
...
lexit:
    ...
    if (u32PllClkSrc == 0x00000000UL)
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00000000UL | (((3)-2)<<9) | ((96)-2) | 0xC000UL);  
    else
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00880000UL | (((3)-2)<<9) |((48)-2) | 0xC000UL);  
